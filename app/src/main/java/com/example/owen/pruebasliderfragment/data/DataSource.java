...
public class DataSource {
    ...
    // hace falta cambiar para hacer las consultas de las respuestas
...
/*
    ...
    public ArrayList<String> getRespuestaCorrecta(int IDQuestion){
...
*/
    ...
    public void updatePregunta(BeanQuestions pregunta, int wrong){
        SQLiteDatabase db = this.openReadable();
        ContentValues args = new ContentValues();
